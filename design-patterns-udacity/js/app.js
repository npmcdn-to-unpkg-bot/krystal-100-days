...
var HorrorController = new BookController('.horror-books', {
  books: horrorBooks,
  currentBook: horrorBooks[0]
})

var ComicsController = new BookController('.comics-books', {
  books: comicBooks,
  currentBook: comicBooks[0]
})
